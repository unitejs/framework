...
export class ParameterValidation {
    ...
    public static notEmpty(display: IDisplay, name: string, value: string | string[] | undefined | null): boolean {
        if (value === undefined || value === null || value.length === 0) {
            display.error(name, "parameter is missing.");
            return false;
        }
    ...
    public static isNumeric(display: IDisplay, name: string, value: string | undefined | null): boolean {
        if (value === undefined || value === null || value.length === 0) {
            display.error(name, "parameter is missing.");
            return false;
        }
    ...
    public static isColor(display: IDisplay, name: string, value: string | undefined | null): boolean {
        if (value === undefined || value === null || value.length === 0) {
            display.error(name, "parameter is missing.");
            return false;
        }
    ...
    public static async contains(display: IDisplay, name: string, values: string[], value: string | undefined | null, error: string): Promise<boolean> {
        if (value === undefined || value === null || value.length === 0) {
            display.error(name, "parameter is missing.");
            return false;
        }
